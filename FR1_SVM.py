...
for dataset_file in dataset_files:
    ...
    clf.fit(X_new, y)
    model_file = f'D:\\uit\\bao mat web\\project mldroid\\{dataset_file.replace(".xlsx", "_FR1_SVM_model.joblib")}'
...
# Plot the boxplots
plt.boxplot([accuracies, f_measures], labels=['Accuracy', 'F-measure'])
plt.title('Accuracy and F-measure boxplots for all datasets')
plt.show()
